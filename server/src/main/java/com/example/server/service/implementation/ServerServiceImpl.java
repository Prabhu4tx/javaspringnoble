...
public class ServerServiceImpl implements ServerService {
    ...
    public Server ping(String ipAddress) throws IOException {
        log.info("SPinging server IP: {}", ipAddress);
    ...
    public Boolean delete(Long id) {
        log.info("Deleter  server by id : {}", id);
    ...
    private String setServerImageUrl()
    {
        String[] imageNames = { "server1.png", "server2.png", "server3.png", "server4.png" };
         ServletUriComponentsBuilder.fromCurrentContextPath().path("/Users/prabhu4029/Downloads/images/" + imageNames[new Random().nextInt( 4)]).toUriString();
         return null;
    }
}